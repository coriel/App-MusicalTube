...
<div data-role="page" id="pageone">
  ...
  <div data-role="main" class="ui-content">
   <br />
	<font class="font_title">노트르담 드 파리(노트르담의 꼽추)</font>
	<br />
	<font class="font_title_original">Notre-Dame de Paris</font>
	<br />
	<font class="font_title_desc">1998 | 프랑스 | 송 쓰루 | 불어 | 한글자막</font>
	<br />
	<br />
